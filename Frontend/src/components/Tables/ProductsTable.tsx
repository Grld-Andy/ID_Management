...
import EditProductDialog from "../Dialog/Product/EditProductDialog";
...
const ProductsTable: React.FC<Props> = ({ products, sortBy, setSortBy }) => {
        ...
        <div className="w-full border rounded-md overflow-hidden">
          ...
          <div className="divide-y divide-gray-300">
            {products.map((product, index) => (
              <div
                key={index}
                className="grid grid-cols-[50px,1fr,2fr,repeat(2,1fr),115px] pr-1 bg-white items-center hover:bg-gray-100 transition-colors duration-200"
              >
